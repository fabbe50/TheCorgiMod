...
public class CreeperCorgiPowerLayer extends EnergySwirlLayer<CreeperCorgi, CreeperCorgiModel<CreeperCorgi>> {
    private static final ResourceLocation POWER_LOCATION = TheCorgiMod.location("textures/entity/creeper/creeper_armor.png");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        body.addOrReplaceChild("body_fins", CubeListBuilder.create(), PartPose.ZERO);
        PartDefinition wings = body.addOrReplaceChild("wings", CubeListBuilder.create(), PartPose.ZERO);
        wings.addOrReplaceChild("right_wing", CubeListBuilder.create(), PartPose.ZERO);
        wings.addOrReplaceChild("left_wing", CubeListBuilder.create(), PartPose.ZERO);

        partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(83, 10).addBox(-1.5F, -2.5F, -0.5F, 3.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 17.0F, 7.0F));
        ...
        head.addOrReplaceChild("mouth", CubeListBuilder.create(), PartPose.ZERO);
        head.addOrReplaceChild("head_fins", CubeListBuilder.create(), PartPose.ZERO);


        partdefinition.addOrReplaceChild("rb_leg", CubeListBuilder.create().texOffs(36, 33).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 20.0F, 7.0F));
        partdefinition.addOrReplaceChild("rf_leg", CubeListBuilder.create().texOffs(36, 33).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 20.0F, -7.0F));
        partdefinition.addOrReplaceChild("lb_leg", CubeListBuilder.create().texOffs(36, 33).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 20.0F, 7.0F));
        partdefinition.addOrReplaceChild("lf_leg", CubeListBuilder.create().texOffs(36, 33).addBox(-1.5F, -0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, 20.0F, -7.0F));
    ...
    @Override
    protected @NotNull EntityModel<CreeperCorgi> model() {
        return this.model;
    }
}
