...
import com.fabbe50.corgis.entities.ai.CreeperSwellDecoyGoal;
...
public class CreeperCorgiEntity extends MonsterEntity implements ICorgi, IChargeableMob {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new CreeperSwellDecoyGoal(this));
    ...
    protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
        ...
        if (entity != this && entity instanceof CreeperCorgiEntity) {
            CreeperCorgiEntity creeperentity = (CreeperCorgiEntity)entity;
