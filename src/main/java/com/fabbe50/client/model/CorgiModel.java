...
public class CorgiModel extends ModelBase {
    ...
    public void setLivingAnimations(EntityLivingBase entityIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        CorgiEntity entitycorgi = (CorgiEntity)entityIn;
        ...
        this.Face.rotateAngleZ = entitycorgi.getInterestedAngle(partialTickTime) + entitycorgi.getShakeAngle(partialTickTime, 0.0F);
        this.EarRight.rotateAngleZ = entitycorgi.getInterestedAngle(partialTickTime) + entitycorgi.getShakeAngle(partialTickTime, 0.0F);
        this.EarLeft.rotateAngleZ = entitycorgi.getInterestedAngle(partialTickTime) + entitycorgi.getShakeAngle(partialTickTime, 0.0F);
        this.MouthLower.rotateAngleZ = entitycorgi.getInterestedAngle(partialTickTime) + entitycorgi.getShakeAngle(partialTickTime, 0.0F);
        this.MouthUpper.rotateAngleZ = entitycorgi.getInterestedAngle(partialTickTime) + entitycorgi.getShakeAngle(partialTickTime, 0.0F);
        this.Body.rotateAngleZ = entitycorgi.getShakeAngle(partialTickTime, -0.16F);
        this.Tail.rotateAngleZ = entitycorgi.getShakeAngle(partialTickTime, -0.2F);
    }
