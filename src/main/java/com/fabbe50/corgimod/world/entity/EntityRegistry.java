...
public class EntityRegistry {
    ...
    public static final RegistryObject<EntityType<Corgi>> CORGI_NORMAL = DEFERRED_REGISTER.register("corgi_normal", () -> registerEntity(EntityType.Builder.of(Corgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_normal"));
    public static final RegistryObject<EntityType<AntiCorgi>> CORGI_ANTI = DEFERRED_REGISTER.register("corgi_anti", () -> registerEntity(EntityType.Builder.of(AntiCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_anti"));
    public static final RegistryObject<EntityType<BodyguardCorgi>> CORGI_BODYGUARD = DEFERRED_REGISTER.register("corgi_bodyguard", () -> registerEntity(EntityType.Builder.of(BodyguardCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_bodyguard"));
    public static final RegistryObject<EntityType<BusinessCorgi>> CORGI_BUSINESS = DEFERRED_REGISTER.register("corgi_business", () -> registerEntity(EntityType.Builder.of(BusinessCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_business"));
    public static final RegistryObject<EntityType<CreeperCorgi>> CORGI_CREEPER = DEFERRED_REGISTER.register("corgi_creeper", () -> registerEntity(EntityType.Builder.of(CreeperCorgi::new, MobCategory.MONSTER).sized(0.8f, 0.5f), "corgi_creeper"));
    public static final RegistryObject<EntityType<Fabbe50Corgi>> CORGI_FABBE50 = DEFERRED_REGISTER.register("corgi_fabbe50", () -> registerEntity(EntityType.Builder.of(Fabbe50Corgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_fabbe50"));
    public static final RegistryObject<EntityType<FarmerCorgi>> CORGI_FARMER = DEFERRED_REGISTER.register("corgi_farmer", () -> registerEntity(EntityType.Builder.of(FarmerCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_farmer"));
    public static final RegistryObject<EntityType<HeroCorgi>> CORGI_HERO = DEFERRED_REGISTER.register("corgi_hero", () -> registerEntity(EntityType.Builder.of(HeroCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_hero"));
    public static final RegistryObject<EntityType<LoveCorgi>> CORGI_LOVE = DEFERRED_REGISTER.register("corgi_love", () -> registerEntity(EntityType.Builder.of(LoveCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_love"));
    public static final RegistryObject<EntityType<MelonCorgi>> CORGI_MELON = DEFERRED_REGISTER.register("corgi_melon", () -> registerEntity(EntityType.Builder.of(MelonCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_melon"));
    public static final RegistryObject<EntityType<NerdCorgi>> CORGI_NERD = DEFERRED_REGISTER.register("corgi_nerd", () -> registerEntity(EntityType.Builder.of(NerdCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_nerd"));
    public static final RegistryObject<EntityType<PirateCorgi>> CORGI_PIRATE = DEFERRED_REGISTER.register("corgi_pirate", () -> registerEntity(EntityType.Builder.of(PirateCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_pirate"));
    public static final RegistryObject<EntityType<RadioactiveCorgi>> CORGI_RADIOACTIVE = DEFERRED_REGISTER.register("corgi_radioactive", () -> registerEntity(EntityType.Builder.of(RadioactiveCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_radioactive"));
    public static final RegistryObject<EntityType<SkeletonCorgi>> CORGI_SKELETON = DEFERRED_REGISTER.register("corgi_skeleton", () -> registerEntity(EntityType.Builder.of(SkeletonCorgi::new, MobCategory.MONSTER).sized(0.8f, 0.5f), "corgi_skeleton"));
    public static final RegistryObject<EntityType<SpyCorgi>> CORGI_SPY = DEFERRED_REGISTER.register("corgi_spy", () -> registerEntity(EntityType.Builder.of(SpyCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_spy"));
    public static final RegistryObject<EntityType<SunglassesCorgi>> CORGI_SUNGLASSES = DEFERRED_REGISTER.register("corgi_sunglasses", () -> registerEntity(EntityType.Builder.of(SunglassesCorgi::new, MobCategory.CREATURE).sized(0.8f, 0.5f), "corgi_sunglasses"));
    public static final RegistryObject<EntityType<ZombieCorgi>> CORGI_ZOMBIE = DEFERRED_REGISTER.register("corgi_zombie", () -> registerEntity(EntityType.Builder.of(ZombieCorgi::new, MobCategory.MONSTER).sized(0.8f, 0.5f), "corgi_zombie"));
