...
public class EntityRegistry {
    ...
    public static final Supplier<EntityType<Corgi>> CORGI_NORMAL =                  DEFERRED_REGISTER.register("corgi_normal",      () -> EntityType.Builder.of(Corgi::new,             MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_normal"));
    public static final Supplier<EntityType<AntiCorgi>> CORGI_ANTI =                DEFERRED_REGISTER.register("corgi_anti",        () -> EntityType.Builder.of(AntiCorgi::new,         MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_anti"));
    public static final Supplier<EntityType<BodyguardCorgi>> CORGI_BODYGUARD =      DEFERRED_REGISTER.register("corgi_bodyguard",   () -> EntityType.Builder.of(BodyguardCorgi::new,    MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_bodyguard"));
    public static final Supplier<EntityType<BusinessCorgi>> CORGI_BUSINESS =        DEFERRED_REGISTER.register("corgi_business",    () -> EntityType.Builder.of(BusinessCorgi::new,     MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_business"));
    public static final Supplier<EntityType<CreeperCorgi>> CORGI_CREEPER =          DEFERRED_REGISTER.register("corgi_creeper",     () -> EntityType.Builder.of(CreeperCorgi::new,      MobCategory.MONSTER) .sized(0.8f, 0.5f).build("corgi_creeper"));
    public static final Supplier<EntityType<Fabbe50Corgi>> CORGI_FABBE50 =          DEFERRED_REGISTER.register("corgi_fabbe50",     () -> EntityType.Builder.of(Fabbe50Corgi::new,      MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_fabbe50"));
    public static final Supplier<EntityType<FarmerCorgi>> CORGI_FARMER =            DEFERRED_REGISTER.register("corgi_farmer",      () -> EntityType.Builder.of(FarmerCorgi::new,       MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_farmer"));
    public static final Supplier<EntityType<HeroCorgi>> CORGI_HERO =                DEFERRED_REGISTER.register("corgi_hero",        () -> EntityType.Builder.of(HeroCorgi::new,         MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_hero"));
    public static final Supplier<EntityType<LoveCorgi>> CORGI_LOVE =                DEFERRED_REGISTER.register("corgi_love",        () -> EntityType.Builder.of(LoveCorgi::new,         MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_love"));
    public static final Supplier<EntityType<MelonCorgi>> CORGI_MELON =              DEFERRED_REGISTER.register("corgi_melon",       () -> EntityType.Builder.of(MelonCorgi::new,        MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_melon"));
    public static final Supplier<EntityType<NerdCorgi>> CORGI_NERD =                DEFERRED_REGISTER.register("corgi_nerd",        () -> EntityType.Builder.of(NerdCorgi::new,         MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_nerd"));
    public static final Supplier<EntityType<PirateCorgi>> CORGI_PIRATE =            DEFERRED_REGISTER.register("corgi_pirate",      () -> EntityType.Builder.of(PirateCorgi::new,       MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_pirate"));
    public static final Supplier<EntityType<RadioactiveCorgi>> CORGI_RADIOACTIVE =  DEFERRED_REGISTER.register("corgi_radioactive", () -> EntityType.Builder.of(RadioactiveCorgi::new,  MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_radioactive"));
    public static final Supplier<EntityType<SkeletonCorgi>> CORGI_SKELETON =        DEFERRED_REGISTER.register("corgi_skeleton",    () -> EntityType.Builder.of(SkeletonCorgi::new,     MobCategory.MONSTER) .sized(0.8f, 0.5f).build("corgi_skeleton"));
    public static final Supplier<EntityType<SpyCorgi>> CORGI_SPY =                  DEFERRED_REGISTER.register("corgi_spy",         () -> EntityType.Builder.of(SpyCorgi::new,          MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_spy"));
    public static final Supplier<EntityType<SunglassesCorgi>> CORGI_SUNGLASSES =    DEFERRED_REGISTER.register("corgi_sunglasses",  () -> EntityType.Builder.of(SunglassesCorgi::new,   MobCategory.CREATURE).sized(0.8f, 0.5f).build("corgi_sunglasses"));
    public static final Supplier<EntityType<ZombieCorgi>> CORGI_ZOMBIE =            DEFERRED_REGISTER.register("corgi_zombie",      () -> EntityType.Builder.of(ZombieCorgi::new,       MobCategory.MONSTER) .sized(0.8f, 0.5f).build("corgi_zombie"));
