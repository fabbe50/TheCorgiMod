...
public class EnderCorgiRenderer extends MobRenderer<EnderCorgi, EnderCorgiModel<EnderCorgi>> {
    ...
    @Override
    public void render(EnderCorgi livingEntity, float f, float g, @NotNull PoseStack poseStack, @NotNull MultiBufferSource multiBufferSource, int i) {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(@NotNull EnderCorgi corgi) {
